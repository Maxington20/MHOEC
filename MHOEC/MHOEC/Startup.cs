...
namespace MHOEC
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
			...
			//This allows us to connect to and access the OEC SQL database we created in order to  
			//have our CRUD operations impact the database accordingly.
