...
{
    public class MHCountriesController : Controller
    {
        private readonly OECContext _context;

        public MHCountriesController(OECContext context)
        {
            _context = context;
        }
        ...
        // GET: MHCountries/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: MHCountries/Create
