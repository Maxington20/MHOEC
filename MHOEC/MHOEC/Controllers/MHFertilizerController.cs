...
{
    public class MHFertilizerController : Controller
    {
        private readonly OECContext _context;

        public MHFertilizerController(OECContext context)
        {
            _context = context;
        }
        ...
        // GET: MHFertilizer/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: MHFertilizer/Create
